  ...
  return (
    <>
      <div className="bg-transparent  p-8 rounded-lg shadow-md text-center">
        ...
        <button
          className="bg-transparent border-2 p-8 hover:bg-[#232024] text-white font-bold py-3 px-6 rounded-1.5xl text-xl transition duration-300 ease-in-out transform hover:scale-105"
          onClick={handleStart}
        >
          Start Quiz
        </button>
